...
export default function EducationCard({ education, isOwner, signedIn, data, setData, onEdit }) {
    ...
    return(
        <div css={card}>
                ...
                {isOwner && <div css={editBtns}><Button edit onClick={(e) => onEdit(education)} text="Edit"/><Button text="Delete" del onClick={del}/></div>}
        </div>
    )
}